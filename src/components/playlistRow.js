...
const PlaylistRow = ({ onContextMenu, id, draggable, source, shuffleButton, index, playlist, onClick, onDoubleClick, bulbOn, onBulbClick, selected, bulbCheckOn, onBulbCheckClick, icon, onLongPress, onSwipedLeft, onDrop, onSwipedRight}) => {
