...
const ReordableTrackList = ({allowDrop, onAlbumClick, ref, onBulbsClick, onContextMenu, enableDrag, source, trackList, onClick, onDoubleClick, dragEndHandler, keys, onSwipedRight, onDrop, selectedIndex, view }) => {
